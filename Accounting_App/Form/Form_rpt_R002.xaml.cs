...
--where book_type != 0
order by book", new string[] { });  //庫存表開放查詢總帳冊
        ...
        private void Btn_Execute_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                List<BookBase> Books = DBService.GetBookBase(true).Where(x => GetSelectedBook().Contains(x.book)).ToList();  //取得帳冊清單(含總帳)
                ...
                workBook = xlApp.Workbooks.Open(System.Environment.CurrentDirectory + @"\Report_R002.xlsx");
